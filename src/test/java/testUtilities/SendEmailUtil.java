...
public class SendEmailUtil {
    ...
    public static MessageResponse sendMutualFundsReportMailGun(String htmlContent, boolean fundsHealthCheck) {
        ...
        Message message = Message.builder()
                ...
                .subject(getEmailSubject(fundsHealthCheck))
                .html(htmlContent)
                .build();
    ...
    private static String getEmailSubject(boolean fundsHealthCheck) {
        return fundsHealthCheck
                ? "[PASSED] Mutual Fund Tracker: All Funds are beating Category Average and BenchMark Returns"
                : "[FAILED] Mutual Fund Tracker: One or more funds are not able to beat Category Average and BenchMark Returns";
    }
